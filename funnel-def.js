(function () {
  var html = '<div class="card" style="margin-top:28px">' +
    ...
    '<tr style="border-bottom:1px solid #e8e6e1;background:#fafaf8"><td style="padding:8px 12px">予約フォーム到達率</td><td style="padding:8px 12px;color:#aaa">通過率</td><td style="padding:8px 12px;font-family:\'DM Sans\',monospace;font-size:13px">予約フォーム表示 ÷ ACページ訪問 × 100</td></tr>' +
