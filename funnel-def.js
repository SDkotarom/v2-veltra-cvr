(function () {
  var html = '<div class="card" style="margin-top:28px">' +
    ...
    '<tr style="border-bottom:1px solid #e8e6e1;background:#fafaf8"><td style="padding:8px 12px">ACページ訪問率</td><td style="padding:8px 12px;color:#aaa">通過率</td><td style="padding:8px 12px;font-family:\'DM Sans\',monospace;font-size:13px">ACページ訪問 ÷ サイト訪問 × 100<br><code style="font-size:11px;color:#aaa">ac_page_reach_users / session_start_users</code></td></tr>' +
    '<tr style="border-bottom:1px solid #e8e6e1;background:#fafaf8"><td style="padding:8px 12px">カレンダー表示率</td><td style="padding:8px 12px;color:#aaa">通過率</td><td style="padding:8px 12px;font-family:\'DM Sans\',monospace;font-size:13px">カレンダー表示 ÷ ACページ訪問 × 100<br><code style="font-size:11px;color:#aaa">calendar_view / ac_page_reach_users</code></td></tr>' +
    '<tr style="border-bottom:1px solid #e8e6e1;background:#fafaf8"><td style="padding:8px 12px">予約フォーム到達率</td><td style="padding:8px 12px;color:#aaa">通過率</td><td style="padding:8px 12px;font-family:\'DM Sans\',monospace;font-size:13px">予約フォーム表示 ÷ カレンダー表示 × 100<br><code style="font-size:11px;color:#aaa">form_start / calendar_view</code></td></tr>' +
    '<tr style="border-bottom:1px solid #e8e6e1;background:#fafaf8"><td style="padding:8px 12px">予約完了率</td><td style="padding:8px 12px;color:#aaa">通過率</td><td style="padding:8px 12px;font-family:\'DM Sans\',monospace;font-size:13px">予約完了 ÷ 予約フォーム表示 × 100<br><code style="font-size:11px;color:#aaa">purchase / form_start</code></td></tr>' +
    '<tr style="background:#fafaf8"><td style="padding:8px 12px">全体CVR</td><td style="padding:8px 12px;color:#aaa">通過率</td><td style="padding:8px 12px;font-family:\'DM Sans\',monospace;font-size:13px">予約完了 ÷ 全セッション数 × 100<br><code style="font-size:11px;color:#aaa">purchases / sessions</code> <span style="font-size:11px;color:#aaa">※sessionsベース（KPIサマリーと同値）</span></td></tr>' +
