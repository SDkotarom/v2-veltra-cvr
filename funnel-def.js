(function () {
  var html = '<div class="card" style="margin-top:28px">' +
    ...
    '<tr style="border-bottom:1px solid #e8e6e1;background:#fafaf8"><td style="padding:8px 12px">予約フォーム到達率</td><td style="padding:8px 12px;color:#aaa">通過率</td><td style="padding:8px 12px;font-family:\'DM Sans\',monospace;font-size:13px">予約フォーム表示 ÷ カレンダー表示 × 100</td></tr>' +
    ...
    '<tr style="background:#fafaf8"><td style="padding:8px 12px">全体CVR</td><td style="padding:8px 12px;color:#aaa">通過率</td><td style="padding:8px 12px;font-family:\'DM Sans\',monospace;font-size:13px">予約完了（transactions）÷ 全セッション数（sessions）× 100<br><span style="font-size:12px;color:#aaa;font-family:inherit">※ 主要KPIサマリーの値。ファネルの activeUsers ベースとは異なる</span></td></tr>' +
