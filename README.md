...
VELTRA CVR改善プロジェクトの隔週ボトルネック分析レポート。

- **ダッシュボード**: https://v2-veltra-cvr.vercel.app/
- **運用マニュアル**: [docs/playbook.md](docs/playbook.md) — 隔週レポート生成手順・品質チェックリスト
...
```
隔週（偶数週）月曜 AM 4:00 JST（土曜データを1日寝かせて確定）
...
| `docs/playbook.md` | 隔週運用マニュアル（手順・チェックリスト） | 運用者 |
